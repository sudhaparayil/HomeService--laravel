...
<head>
    <meta charset="utf-8">
    <title>yourlogo - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            ...
                            <li><a href="mailto:contact@youraddress.in"><i class="fa fa-envelope"></i>
                                    contact@youraddress.in</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            ...
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> youraddress</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> youraddress</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        @if (Route::has('login'))
                            ...
                            @auth  
                             @if(Auth::user()->usertype==='ADM')
                                    <li class="login-form"> My Account(admin)
                                        <ul class="drop-down one-column hover-fade">
                                ...
                                @elseif(Auth::user()->usertype==='SVP')
                                    <li class="login-form"> My Account(service provider)
                                        <ul class="drop-down one-column hover-fade">
                                ...
                                @else 
                                    <li class="login-form"> My Account(customer)
                                        <ul class="drop-down one-column hover-fade">
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> youraddress, India</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@youraddress.in">contact@youraddress.in</a>
                            </li>
                            <li>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 youraddress. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
