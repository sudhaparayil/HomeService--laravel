                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" wire:submit.prevent="createNewService">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <select  class="form-control"  name="service_category_id" id="service_category_id" wire:model="service_category_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select  class="form-control" id="discount_type" name="discount_type" wire:model="discount_type">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea  class="form-control" id="inclusion" name="inclusion" wire:model="inclusion"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea  class="form-control" id="exclusion" name="Exclusion" wire:model="exclusion"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file"  id="thumbnail" name="thumbnail" wire:model="thumbnail">
